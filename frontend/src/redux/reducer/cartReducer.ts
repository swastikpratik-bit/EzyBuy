...
export const carteRedcuer = createSlice({
    ...
    reducers: {
        ...
        calculatePrice : (state) => {
            let subtotal = state.cartItems.reduce((tot , item) => tot + item.price * item.quantity , 0);
...
export const { addToCart , removeCartItem , calculatePrice , discountApplied , saveShippingInfo , resetCart }  =  carteRedcuer.actions;